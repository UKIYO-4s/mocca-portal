...
mysql -u root -e "CREATE USER 'mocca'@'localhost' IDENTIFIED BY 'mocca_secure_pass_2025';"
...
| 項目 | .env変数 | 状態 |
|------|----------|------|
| Google OAuth | GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET | ⬜ 未設定 |
