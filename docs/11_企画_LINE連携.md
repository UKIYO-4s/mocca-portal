...
**方針**: 日々の業務を圧縮する機能を最優先 → あったら便利な機能は後回し

### フェーズ1: 業務圧縮（最優先）
| 優先度 | モジュール | 削減できる業務 |
|:------:|-----------|---------------|
| 1 | Line（コア+多店舗） | 全機能の基盤（必須） |
| 2 | LineDelivery | **電話注文対応・決済処理・配達確認** |
| 3 | LineChatbot | **問い合わせ電話・DM対応** |
| 4 | LineAnalytics（日報） | **日次レポート作成作業** |

### フェーズ2: 業務効率化
| 優先度 | モジュール | 削減できる業務 |
|:------:|-----------|---------------|
| 5 | LineNotification | **リマインド電話 → LINE自動送信** |
| 6 | LineCoupon | クーポン発行・管理の手作業 |
| 7 | LineCrm | 顧客情報の手動管理 |

### フェーズ3: あったら便利（余裕ができたら）
| 優先度 | モジュール | 効果 |
|:------:|-----------|------|
| 8 | LinePoints | リピート促進 |
| 9 | LineReview | 口コミ収集・評価向上 |
| 10 | LineReferral | 新規顧客獲得 |
...
| 現在の業務（電話） | LINE導入後 | 削減効果 |
|-------------------|-----------|---------|
| 電話でデリバリー注文受付 | LINEで自動受付 | **大** |
| 注文内容の復唱・確認 | 自動確定 | **大** |
| 「まだ届かない？」の電話対応 | 出発・到着の自動通知 | **大** |
| 営業時間・駐車場等の問い合わせ | チャットボット自動応答 | **大** |
| 予約リマインド電話 | **LINE自動メッセージ** | **大** |
| 日報作成（売上・予約集計） | 自動配信 | **中** |
| クーポン発行・配布 | 自動化 | **小** |
...
| 2026-01-03 | 優先度見直し: 業務圧縮優先（デリバリー→チャットボット→日報）に変更 |
