    ...
    const ConfirmationView = () => (
        <div className="space-y-4">
            ...
            <div className="divide-y divide-gray-200 rounded-lg border border-gray-200">
                <div className="p-4">
                    <h4 className="text-sm font-medium text-gray-500">お客様情報</h4>
                    <p className="mt-1 text-lg">{formData.name}（{formData.name_kana}）様</p>
                ...
                <div className="p-4">
                    <h4 className="text-sm font-medium text-gray-500">宿泊情報</h4>
                    <p className="mt-1 text-lg">
                        {formData.checkin_date} 〜 {formData.checkout_date}
                    </p>
                    <p className="text-sm text-gray-600">
                        大人{formData.guest_count_adults}名
                        {formData.guest_count_children > 0 && `、子供${formData.guest_count_children}名`}
                    </p>
                </div>
                <div className="p-4">
                    <h4 className="text-sm font-medium text-gray-500">お食事・オプション</h4>
                    <p className="mt-1 text-lg">
                ...
                <div className="p-4">
                    <h4 className="text-sm font-medium text-gray-500">お支払い</h4>
                    <p className="mt-1 text-lg">
                        {formData.payment_method === 'cash' && '現金'}
                        {formData.payment_method === 'credit' && 'クレジットカード'}
                        {formData.payment_method === 'bank_transfer' && '銀行振込'}
                    </p>
                </div>
                {formData.notes && (
                    <div className="p-4">
                        <h4 className="text-sm font-medium text-gray-500">備考</h4>
                        <p className="mt-1 text-sm text-gray-600 whitespace-pre-wrap">{formData.notes}</p>
                    </div>
                )}
            </div>
        </div>
                        ...
                        <>
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="rounded-lg bg-white p-6 shadow-sm">
                                    {step === 1 && <CustomerInfoFields />}
                                    {step === 2 && <StayInfoFields />}
                                    {step === 3 && <MealOptionsFields />}
                                    {step === 4 && <PaymentNotesFields />}
                                    {step === 5 && <ConfirmationView />}
