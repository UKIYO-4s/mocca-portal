        ...
        <GuestLayout>
            ...
            <div className="mb-6 rounded-lg bg-blue-50 p-4">
                <div className="text-sm text-gray-700">
                    <p>ロール: <span className="font-medium text-gray-900">{invite.role_label}</span></p>
                    {invite.email && (
                        <p className="mt-1">メールアドレス: <span className="font-medium text-gray-900">{invite.email}</span></p>
                    )}
                </div>
            </div>
