                            ...
                            <div className="mt-6">
                                <div className="flex items-center justify-between">
                                    ...
                                    <button
                                        type="button"
                                        onClick={addItem}
                                        className="active:bg-indigo-900:ring-offset-gray-800 inline-flex items-center rounded-md border border-transparent bg-indigo-600 px-3 py-1.5 text-xs font-semibold uppercase tracking-widest text-white transition duration-150 ease-in-out hover:bg-indigo-700 focus:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                                    >
                                        項目を追加
                                    </button>
                                </div>
                                            ...
                                            >
                                                ...
                                                <div className="flex shrink-0 gap-1">
                                                    <button
                                                        ...
                                                        disabled={index === 0}
                                                        className="disabled:opacity-50:bg-gray-700:text-gray-300 rounded p-1 text-gray-400 hover:bg-gray-200 hover:text-gray-600 disabled:cursor-not-allowed"
                                                        title="上に移動"
                                                    >
                                                        <svg
                                                            className="h-5 w-5"
                                                    ...
                                                    <button
                                                        ...
                                                        className="hover:text-red-600:bg-red-900:text-red-300 rounded p-1 text-red-400 hover:bg-red-100"
                                                        title="削除"
                                                    >
                                                        <svg
                                                            className="h-5 w-5"
